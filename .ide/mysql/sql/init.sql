...
insert into sys_menu values('112',  'Nacos控制台',    '2',   '4', 'http://localhost:8948/nacos',  '',                '', 0, 0, 'C', '0', '0', 'monitor:nacos:list',      'nacos',         'admin', sysdate(), '', null, '服务治理菜单');
...
insert into sys_menu values('116',  '系统接口',       '3',   '3', 'http://localhost:8180/swagger-ui/index.html', '', '', 0, 0, 'C', '0', '0', 'tool:swagger:list',       'swagger',       'admin', sysdate(), '', null, '系统接口菜单');
-- 三级菜单
